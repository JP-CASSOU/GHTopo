...
TPostScriptCanvas = class
  ...
  public
    ...
    procedure DrawPolylign(const Points: array of TPSPoint2Df);
    procedure DrawPolygon(const Points: array of TPSPoint2Df);
    procedure DrawBorderedPolygon(const Points: array of TPSPoint2Df);
...
procedure TPostScriptCanvas.DrawPolylign(const Points: array of TPSPoint2Df);
var
  i: integer;
begin
...
procedure TPostScriptCanvas.DrawPolygon(const Points: array of TPSPoint2Df);
var
  i: integer;
begin
  if (High(Points)<1) then Exit;
...
procedure TPostScriptCanvas.DrawBorderedPolygon(const Points: array of TPSPoint2Df);
var
  i: integer;
begin
  if (High(Points)<1) then Exit;
